...
import {DtoRetentionPolicyFromJSON, DtoRetentionPolicyToJSON,} from "./DtoRetentionPolicy";
 ...
 */
export function instanceOfDtoBackupPolicy(
  value: object,
): value is DtoBackupPolicy {
  return true;
}
...
export function DtoBackupPolicyFromJSONTyped(
  json: any,
  ...
  return {
    ...
    concurrentIncremental:
      json["concurrent-incremental"] == null
        ? undefined
        : json["concurrent-incremental"],
    encryption:
    ...
    maxConcurrentNodes:
      json["max-concurrent-nodes"] == null
        ? undefined
        : json["max-concurrent-nodes"],
    ...
    parallelWrite:
      json["parallel-write"] == null ? undefined : json["parallel-write"],
    recordsPerSecond:
    ...
    retention:
      json["retention"] == null
        ? undefined
        : DtoRetentionPolicyFromJSON(json["retention"]),
    retryPolicy:
    ...
    useScanCompression:
      json["use-scan-compression"] == null
        ? undefined
        : json["use-scan-compression"],
    withClusterConfiguration:
      json["with-cluster-configuration"] == null
        ? undefined
        : json["with-cluster-configuration"],
  };
}
...
export function DtoBackupPolicyToJSONTyped(
  value?: DtoBackupPolicy | null,
