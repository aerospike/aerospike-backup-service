 ...
 */
export function instanceOfDtoRetentionPolicy(
  value: object,
): value is DtoRetentionPolicy {
  return true;
}
...
export function DtoRetentionPolicyFromJSONTyped(
  json: any,
...
export function DtoRetentionPolicyToJSONTyped(
  value?: DtoRetentionPolicy | null,
