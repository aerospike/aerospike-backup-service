 ...
 */
export function instanceOfDtoRetryPolicy(value: object): value is DtoRetryPolicy {
    return true;
}
...
export function DtoRetryPolicyFromJSONTyped(json: any, ignoreDiscriminator: boolean): DtoRetryPolicy {
    if (json == null) {
        return json;
    }
    return {
...
export function DtoRetryPolicyToJSONTyped(value?: DtoRetryPolicy | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
