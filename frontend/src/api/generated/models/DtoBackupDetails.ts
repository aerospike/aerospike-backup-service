 ...
 */
export function instanceOfDtoBackupDetails(
  value: object,
): value is DtoBackupDetails {
  return true;
}
...
export function DtoBackupDetailsFromJSONTyped(
  json: any,
  ...
  return {
    ...
    recordCount:
      json["record-count"] == null ? undefined : json["record-count"],
    secondaryIndexCount:
      json["secondary-index-count"] == null
        ? undefined
        : json["secondary-index-count"],
    storage:
      json["storage"] == null ? undefined : DtoStorageFromJSON(json["storage"]),
...
export function DtoBackupDetailsToJSONTyped(
  value?: DtoBackupDetails | null,
