 ...
 */
export function instanceOfDtoBackupRoutine(
  value: object,
): value is DtoBackupRoutine {
  if (!("intervalCron" in value) || value["intervalCron"] === undefined)
    return false;
  if (!("namespaces" in value) || value["namespaces"] === undefined)
    return false;
  if (!("sourceCluster" in value) || value["sourceCluster"] === undefined)
    return false;
...
export function DtoBackupRoutineFromJSONTyped(
  json: any,
  ...
  return {
    backupPolicy:
      json["backup-policy"] == null ? undefined : json["backup-policy"],
    binList: json["bin-list"] == null ? undefined : json["bin-list"],
    disabled: json["disabled"] == null ? undefined : json["disabled"],
    incrIntervalCron:
      json["incr-interval-cron"] == null
        ? undefined
        : json["incr-interval-cron"],
    intervalCron: json["interval-cron"],
    namespaces: json["namespaces"],
    nodeList: json["node-list"] == null ? undefined : json["node-list"],
    partitionList:
      json["partition-list"] == null ? undefined : json["partition-list"],
    rackList: json["rack-list"] == null ? undefined : json["rack-list"],
    secretAgent:
      json["secret-agent"] == null ? undefined : json["secret-agent"],
...
export function DtoBackupRoutineToJSONTyped(
  value?: DtoBackupRoutine | null,
