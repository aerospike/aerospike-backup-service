 ...
 */
export function instanceOfDtoRestorePolicy(value: object): value is DtoRestorePolicy {
    return true;
}
...
export function DtoRestorePolicyFromJSONTyped(json: any, ignoreDiscriminator: boolean): DtoRestorePolicy {
    if (json == null) {
        return json;
    }
    return {
        ...
        'disableBatchWrites': json['disable-batch-writes'] == null ? undefined : json['disable-batch-writes'],
        ...
        'maxAsyncBatches': json['max-async-batches'] == null ? undefined : json['max-async-batches'],
        'namespace': json['namespace'] == null ? undefined : DtoRestoreNamespaceFromJSON(json['namespace']),
        'noGeneration': json['no-generation'] == null ? undefined : json['no-generation'],
...
export function DtoRestorePolicyToJSONTyped(value?: DtoRestorePolicy | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
