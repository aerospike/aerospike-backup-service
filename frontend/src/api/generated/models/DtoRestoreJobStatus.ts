 ...
 */
export function instanceOfDtoRestoreJobStatus(value: object): value is DtoRestoreJobStatus {
    return true;
}
...
export function DtoRestoreJobStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): DtoRestoreJobStatus {
    if (json == null) {
        return json;
    }
    return {
        ...
        'existedRecords': json['existed-records'] == null ? undefined : json['existed-records'],
        'expiredRecords': json['expired-records'] == null ? undefined : json['expired-records'],
        'fresherRecords': json['fresher-records'] == null ? undefined : json['fresher-records'],
        'ignoredRecords': json['ignored-records'] == null ? undefined : json['ignored-records'],
        'indexCount': json['index-count'] == null ? undefined : json['index-count'],
        'insertedRecords': json['inserted-records'] == null ? undefined : json['inserted-records'],
        'readRecords': json['read-records'] == null ? undefined : json['read-records'],
        'skippedRecords': json['skipped-records'] == null ? undefined : json['skipped-records'],
...
export function DtoRestoreJobStatusToJSONTyped(value?: DtoRestoreJobStatus | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
