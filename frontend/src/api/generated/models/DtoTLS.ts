...
export function DtoTLSFromJSONTyped(json: any, ignoreDiscriminator: boolean): DtoTLS {
    if (json == null) {
        return json;
    }
    return {
        ...
        'cipherSuite': json['cipher-suite'] == null ? undefined : json['cipher-suite'],
        'keyFile': json['key-file'] == null ? undefined : json['key-file'],
        'keyFilePassword': json['key-file-password'] == null ? undefined : json['key-file-password'],
...
export function DtoTLSToJSONTyped(value?: DtoTLS | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
