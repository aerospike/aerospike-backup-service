...
import {
    ...
    DtoAzureStorageClassToJSON,
    DtoAzureStorageClassToJSONTyped,
} from './DtoAzureStorageClass';
 ...
 */
export function instanceOfDtoAzureStorage(value: object): value is DtoAzureStorage {
...
export function DtoAzureStorageFromJSONTyped(json: any, ignoreDiscriminator: boolean): DtoAzureStorage {
    if (json == null) {
        return json;
    }
    return {
        ...
        'clientSecret': json['client-secret'] == null ? undefined : json['client-secret'],
        ...
        'storageClass': json['storage-class'] == null ? undefined : DtoAzureStorageClassFromJSON(json['storage-class']),
...
export function DtoAzureStorageToJSONTyped(value?: DtoAzureStorage | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
