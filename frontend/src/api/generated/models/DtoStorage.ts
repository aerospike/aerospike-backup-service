...
import {
    ...
    DtoLocalStorageToJSON,
    DtoLocalStorageToJSONTyped,
} from './DtoLocalStorage';
...
export function DtoStorageFromJSONTyped(json: any, ignoreDiscriminator: boolean): DtoStorage {
    if (json == null) {
        return json;
    }
    return {
        ...
        's3Storage': json['s3-storage'] == null ? undefined : DtoS3StorageFromJSON(json['s3-storage']),
    };
}
...
export function DtoStorageToJSONTyped(value?: DtoStorage | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
