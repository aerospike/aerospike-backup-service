...
export function DtoMetricsFromJSONTyped(json: any, ignoreDiscriminator: boolean): DtoMetrics {
    if (json == null) {
        return json;
    }
    return {
...
export function DtoMetricsToJSONTyped(value?: DtoMetrics | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
