                ...
                <div className="mb-8">
                    ...
                    {runningJobs.length === 0 ? (
                        ...
                        <div className="grid gap-4">
                            {currentBackup?.full &&
                                <JobCard routine={activeRoutine} type="Full" job={currentBackup.full}/>}
                            {currentBackup?.incremental &&
                                <JobCard routine={activeRoutine} type="Incremental" job={currentBackup.incremental}/>}
                        </div>
                    )}
                </div>
