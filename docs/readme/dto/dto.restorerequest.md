...
| Field                   | Description                                                                                                                                                                                                                             |
|-------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 📍 `backup-data-path`    | Path to the data from storage root.<br>This path is relative to the storage `path`.<br>You can obtain this value by:<br>- Browsing the storage UI, or<br>- Reading the `key` field in the response from GET `v1/backups/full/{routine}` |
