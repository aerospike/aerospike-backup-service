...
|----------------------------------------------|-------------------------------------------------------------------------------------------------------|---------------|
| `seed-nodes`<span style="color:red">*</span> | The seed nodes details.<br>Array of: [dto.SeedNode](dto.seednode.md)                                  |               |
...
| `max-parallel-scans`                         | Specifies the maximum number of parallel scans per the cluster.                                       |               |
