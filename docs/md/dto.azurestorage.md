...
|--------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------|
| `container-name`<span style="color:red">*</span> | ContainerName is the name of the Azure Blob container.                                                                                                               |               |
| `endpoint`<span style="color:red">*</span>       | Endpoint is the Azure Blob service endpoint URL.                                                                                                                     |               |
