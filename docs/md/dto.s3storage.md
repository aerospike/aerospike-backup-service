...
|---------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------|
| `bucket`<span style="color:red">*</span>    | The S3 bucket name.                                                                                                                                         |               |
| `s3-region`<span style="color:red">*</span> | The S3 region string.                                                                                                                                       |               |
...
| `s3-log-level`                              | The log level of the AWS S3 SDK (AWS S3 optional).                                                                                                          | `FATAL`       |
