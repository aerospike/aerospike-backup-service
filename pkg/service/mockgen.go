...
// Source: github.com/aerospike/aerospike-backup-service/v3/pkg/service (interfaces: RestoreManager,BackupReaderWriter,BackupReader,RunningBackupsRegistry,RetentionManager,ClusterConfigWriter,CancelableBackupHandler,PathService,HistoryManager)
//
// Generated by this command:
//
//	mockgen -package service -destination /Users/ak/work/aerospike-backup-service/pkg/service/mockgen.go github.com/aerospike/aerospike-backup-service/v3/pkg/service RestoreManager,BackupReaderWriter,BackupReader,RunningBackupsRegistry,RetentionManager,ClusterConfigWriter,CancelableBackupHandler,PathService,HistoryManager
//
...
func (m *MockHistoryManager) FindLastRun(ctx context.Context, routineName string) (*model.BackupTime, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindLastRun", ctx, routineName)
...
func (mr *MockHistoryManagerMockRecorder) FindLastRun(ctx, routineName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindLastRun", reflect.TypeOf((*MockHistoryManager)(nil).FindLastRun), ctx, routineName)
}
