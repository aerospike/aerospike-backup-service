...
// Source: github.com/aerospike/aerospike-backup-service/v3/pkg/service (interfaces: RestoreManager,BackupReaderWriter,BackupReader,BackupStateRegistry,BackupRetentionManager,ClusterConfigWriter,CancelableBackupHandler,routineProvider,HistoryManager,BackupCompletionHandler,RestoreValidator,StartController,RoutineBackupRunner,NamespaceBackupRunner,BackupReporter,BackupOrchestrator,JobScheduler,storageFileReader,storageDataWriter)
//
// Generated by this command:
//
//	mockgen -package service -destination pkg/service/mockgen.go -mock_names=routineProvider=mockRoutineProvider,storageFileReader=mockStorageFileReader,storageDataWriter=mockStorageDataWriter github.com/aerospike/aerospike-backup-service/v3/pkg/service RestoreManager,BackupReaderWriter,BackupReader,BackupStateRegistry,BackupRetentionManager,ClusterConfigWriter,CancelableBackupHandler,routineProvider,HistoryManager,BackupCompletionHandler,RestoreValidator,StartController,RoutineBackupRunner,NamespaceBackupRunner,BackupReporter,BackupOrchestrator,JobScheduler,storageFileReader,storageDataWriter
//
