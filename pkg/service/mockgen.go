...
// Source: github.com/aerospike/aerospike-backup-service/v3/pkg/service (interfaces: RestoreManager,BackupReaderWriter,BackupReader,RunningBackupsRegistry,RetentionManager,ClusterConfigWriter,CancelableBackupHandler,routineProvider,HistoryManager,BackupCompletionHandler,RestoreValidator,StartController,AllNamespacesBackupRunner,SingleNamespaceExecutor)
//
// Generated by this command:
//
//	mockgen -package service -destination pkg/service/mockgen.go github.com/aerospike/aerospike-backup-service/v3/pkg/service RestoreManager,BackupReaderWriter,BackupReader,RunningBackupsRegistry,RetentionManager,ClusterConfigWriter,CancelableBackupHandler,routineProvider,HistoryManager,BackupCompletionHandler,RestoreValidator,StartController,AllNamespacesBackupRunner,SingleNamespaceExecutor
//
...
// MockAllNamespacesBackupRunner is a mock of AllNamespacesBackupRunner interface.
type MockAllNamespacesBackupRunner struct {
	ctrl     *gomock.Controller
	recorder *MockAllNamespacesBackupRunnerMockRecorder
	isgomock struct{}
}

// MockAllNamespacesBackupRunnerMockRecorder is the mock recorder for MockAllNamespacesBackupRunner.
type MockAllNamespacesBackupRunnerMockRecorder struct {
	mock *MockAllNamespacesBackupRunner
}

// NewMockAllNamespacesBackupRunner creates a new mock instance.
func NewMockAllNamespacesBackupRunner(ctrl *gomock.Controller) *MockAllNamespacesBackupRunner {
	mock := &MockAllNamespacesBackupRunner{ctrl: ctrl}
	mock.recorder = &MockAllNamespacesBackupRunnerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockAllNamespacesBackupRunner) EXPECT() *MockAllNamespacesBackupRunnerMockRecorder {
	return m.recorder
}
...
type MockSingleNamespaceExecutor struct {
	ctrl     *gomock.Controller
	recorder *MockSingleNamespaceExecutorMockRecorder
	isgomock struct{}
}

// MockSingleNamespaceExecutorMockRecorder is the mock recorder for MockSingleNamespaceExecutor.
type MockSingleNamespaceExecutorMockRecorder struct {
	mock *MockSingleNamespaceExecutor
}

// NewMockSingleNamespaceExecutor creates a new mock instance.
func NewMockSingleNamespaceExecutor(ctrl *gomock.Controller) *MockSingleNamespaceExecutor {
	mock := &MockSingleNamespaceExecutor{ctrl: ctrl}
	mock.recorder = &MockSingleNamespaceExecutorMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockSingleNamespaceExecutor) EXPECT() *MockSingleNamespaceExecutorMockRecorder {
	return m.recorder
}
