...
// Source: github.com/aerospike/aerospike-backup-service/v3/pkg/service (interfaces: RestoreManager,BackupReaderWriter,BackupReader,RunningBackupsRegistry,RetentionManager,ClusterConfigWriter,CancelableBackupHandler,PathService,routineProvider,HistoryManager,BackupCompletionHandler,RestorePreflight)
//
// Generated by this command:
//
//	mockgen -package service -destination pkg/service/mockgen.go github.com/aerospike/aerospike-backup-service/v3/pkg/service RestoreManager,BackupReaderWriter,BackupReader,RunningBackupsRegistry,RetentionManager,ClusterConfigWriter,CancelableBackupHandler,PathService,routineProvider,HistoryManager,BackupCompletionHandler,RestorePreflight
//
...
// MockRestorePreflight is a mock of RestorePreflight interface.
type MockRestorePreflight struct {
	ctrl     *gomock.Controller
	recorder *MockRestorePreflightMockRecorder
	isgomock struct{}
}

// MockRestorePreflightMockRecorder is the mock recorder for MockRestorePreflight.
type MockRestorePreflightMockRecorder struct {
	mock *MockRestorePreflight
}

// NewMockRestorePreflight creates a new mock instance.
func NewMockRestorePreflight(ctrl *gomock.Controller) *MockRestorePreflight {
	mock := &MockRestorePreflight{ctrl: ctrl}
	mock.recorder = &MockRestorePreflightMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockRestorePreflight) EXPECT() *MockRestorePreflightMockRecorder {
	return m.recorder
}

// ValidatePathRestore mocks base method.
func (m *MockRestorePreflight) ValidatePathRestore(ctx context.Context, request *model.RestoreRequest, infoGetter backup.InfoGetter, backups []model.BackupDetails) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ValidatePathRestore", ctx, request, infoGetter, backups)
	ret0, _ := ret[0].(error)
	return ret0
}

// ValidatePathRestore indicates an expected call of ValidatePathRestore.
func (mr *MockRestorePreflightMockRecorder) ValidatePathRestore(ctx, request, infoGetter, backups any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ValidatePathRestore", reflect.TypeOf((*MockRestorePreflight)(nil).ValidatePathRestore), ctx, request, infoGetter, backups)
}

// ValidateTimeRestore mocks base method.
func (m *MockRestorePreflight) ValidateTimeRestore(ctx context.Context, request *model.RestoreTimestampRequest, infoGetter backup.InfoGetter, backupsByNamespace map[string][]model.BackupDetails) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ValidateTimeRestore", ctx, request, infoGetter, backupsByNamespace)
	ret0, _ := ret[0].(error)
	return ret0
}

// ValidateTimeRestore indicates an expected call of ValidateTimeRestore.
func (mr *MockRestorePreflightMockRecorder) ValidateTimeRestore(ctx, request, infoGetter, backupsByNamespace any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ValidateTimeRestore", reflect.TypeOf((*MockRestorePreflight)(nil).ValidateTimeRestore), ctx, request, infoGetter, backupsByNamespace)
}
