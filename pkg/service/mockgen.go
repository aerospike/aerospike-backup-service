...
// Source: github.com/aerospike/aerospike-backup-service/v3/pkg/service (interfaces: RestoreManager,BackupReaderWriter,BackupReader,backupStateReader,backupRunCoordinator,BackupRetentionManager,ClusterConfigWriter,CancelableBackupHandler,routineProvider,HistoryManager,BackupCompletionHandler,RestoreValidator,StartController,RoutineBackupRunner,NamespaceBackupRunner,BackupReporter,BackupOrchestrator,JobScheduler,storageFileReader,storageDataWriter)
//
// Generated by this command:
//
//	mockgen -package service -destination pkg/service/mockgen.go -mock_names=backupStateReader=mockBackupStateReader,backupRunCoordinator=mockBackupRunCoordinator,routineProvider=mockRoutineProvider,storageFileReader=mockStorageFileReader,storageDataWriter=mockStorageDataWriter github.com/aerospike/aerospike-backup-service/v3/pkg/service RestoreManager,BackupReaderWriter,BackupReader,backupStateReader,backupRunCoordinator,BackupRetentionManager,ClusterConfigWriter,CancelableBackupHandler,routineProvider,HistoryManager,BackupCompletionHandler,RestoreValidator,StartController,RoutineBackupRunner,NamespaceBackupRunner,BackupReporter,BackupOrchestrator,JobScheduler,storageFileReader,storageDataWriter
//
...
// mockBackupStateReader is a mock of backupStateReader interface.
type mockBackupStateReader struct {
	ctrl     *gomock.Controller
	recorder *mockBackupStateReaderMockRecorder
	isgomock struct{}
}

// mockBackupStateReaderMockRecorder is the mock recorder for mockBackupStateReader.
type mockBackupStateReaderMockRecorder struct {
	mock *mockBackupStateReader
}

// NewmockBackupStateReader creates a new mock instance.
func NewmockBackupStateReader(ctrl *gomock.Controller) *mockBackupStateReader {
	mock := &mockBackupStateReader{ctrl: ctrl}
	mock.recorder = &mockBackupStateReaderMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *mockBackupStateReader) EXPECT() *mockBackupStateReaderMockRecorder {
	return m.recorder
}

// Cancel mocks base method.
func (m *mockBackupStateReader) Cancel(routineName string) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Cancel", routineName)
}

// Cancel indicates an expected call of Cancel.
func (mr *mockBackupStateReaderMockRecorder) Cancel(routineName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Cancel", reflect.TypeOf((*mockBackupStateReader)(nil).Cancel), routineName)
}

// GetRoutineState mocks base method.
func (m *mockBackupStateReader) GetRoutineState(routine *model.BackupRoutine) model.RoutineState {
	m.ctrl.T.Helper()
...
func (mr *mockBackupStateReaderMockRecorder) GetRoutineState(routine any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetRoutineState", reflect.TypeOf((*mockBackupStateReader)(nil).GetRoutineState), routine)
}

// GetRunningState mocks base method.
func (m *mockBackupStateReader) GetRunningState() map[string]model.RoutineState {
	m.ctrl.T.Helper()
...
func (mr *mockBackupStateReaderMockRecorder) GetRunningState() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetRunningState", reflect.TypeOf((*mockBackupStateReader)(nil).GetRunningState))
}

// SynchroniseBackupHistory mocks base method.
func (m *mockBackupStateReader) SynchroniseBackupHistory(ctx context.Context, routines []*model.BackupRoutine) {
	m.ctrl.T.Helper()
...
func (mr *mockBackupStateReaderMockRecorder) SynchroniseBackupHistory(ctx, routines any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SynchroniseBackupHistory", reflect.TypeOf((*mockBackupStateReader)(nil).SynchroniseBackupHistory), ctx, routines)
}

// mockBackupRunCoordinator is a mock of backupRunCoordinator interface.
type mockBackupRunCoordinator struct {
	ctrl     *gomock.Controller
	recorder *mockBackupRunCoordinatorMockRecorder
	isgomock struct{}
}

// mockBackupRunCoordinatorMockRecorder is the mock recorder for mockBackupRunCoordinator.
type mockBackupRunCoordinatorMockRecorder struct {
	mock *mockBackupRunCoordinator
}

// NewmockBackupRunCoordinator creates a new mock instance.
func NewmockBackupRunCoordinator(ctrl *gomock.Controller) *mockBackupRunCoordinator {
	mock := &mockBackupRunCoordinator{ctrl: ctrl}
	mock.recorder = &mockBackupRunCoordinatorMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *mockBackupRunCoordinator) EXPECT() *mockBackupRunCoordinatorMockRecorder {
	return m.recorder
}

// Cancel mocks base method.
func (m *mockBackupRunCoordinator) Cancel(routineName string) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Cancel", routineName)
}

// Cancel indicates an expected call of Cancel.
func (mr *mockBackupRunCoordinatorMockRecorder) Cancel(routineName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Cancel", reflect.TypeOf((*mockBackupRunCoordinator)(nil).Cancel), routineName)
}

// GetRoutineState mocks base method.
func (m *mockBackupRunCoordinator) GetRoutineState(routine *model.BackupRoutine) model.RoutineState {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRoutineState", routine)
	ret0, _ := ret[0].(model.RoutineState)
	return ret0
...
// GetRoutineState indicates an expected call of GetRoutineState.
func (mr *mockBackupRunCoordinatorMockRecorder) GetRoutineState(routine any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetRoutineState", reflect.TypeOf((*mockBackupRunCoordinator)(nil).GetRoutineState), routine)
}

// GetRunningState mocks base method.
func (m *mockBackupRunCoordinator) GetRunningState() map[string]model.RoutineState {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRunningState")
	ret0, _ := ret[0].(map[string]model.RoutineState)
	return ret0
...
// GetRunningState indicates an expected call of GetRunningState.
func (mr *mockBackupRunCoordinatorMockRecorder) GetRunningState() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetRunningState", reflect.TypeOf((*mockBackupRunCoordinator)(nil).GetRunningState))
}

// SynchroniseBackupHistory mocks base method.
func (m *mockBackupRunCoordinator) SynchroniseBackupHistory(ctx context.Context, routines []*model.BackupRoutine) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SynchroniseBackupHistory", ctx, routines)
}

// SynchroniseBackupHistory indicates an expected call of SynchroniseBackupHistory.
func (mr *mockBackupRunCoordinatorMockRecorder) SynchroniseBackupHistory(ctx, routines any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SynchroniseBackupHistory", reflect.TypeOf((*mockBackupRunCoordinator)(nil).SynchroniseBackupHistory), ctx, routines)
}

// clearFailedBackup mocks base method.
func (m *mockBackupRunCoordinator) clearFailedBackup(routineName string, jt model.BackupType) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "clearFailedBackup", routineName, jt)
}

// clearFailedBackup indicates an expected call of clearFailedBackup.
func (mr *mockBackupRunCoordinatorMockRecorder) clearFailedBackup(routineName, jt any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "clearFailedBackup", reflect.TypeOf((*mockBackupRunCoordinator)(nil).clearFailedBackup), routineName, jt)
}

// recordSuccessfulBackup mocks base method.
func (m *mockBackupRunCoordinator) recordSuccessfulBackup(routine *model.BackupRoutine, jt model.BackupType) {
	m.ctrl.T.Helper()
...
func (mr *mockBackupRunCoordinatorMockRecorder) recordSuccessfulBackup(routine, jt any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "recordSuccessfulBackup", reflect.TypeOf((*mockBackupRunCoordinator)(nil).recordSuccessfulBackup), routine, jt)
}

// register mocks base method.
func (m *mockBackupRunCoordinator) register(routineName string, jt model.BackupType, handler CancelableBackupHandler) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "register", routineName, jt, handler)
}

// register indicates an expected call of register.
func (mr *mockBackupRunCoordinatorMockRecorder) register(routineName, jt, handler any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "register", reflect.TypeOf((*mockBackupRunCoordinator)(nil).register), routineName, jt, handler)
}
...
// mockStorageFileReader is a mock of storageFileReader interface.
type mockStorageFileReader struct {
	ctrl     *gomock.Controller
	recorder *mockStorageFileReaderMockRecorder
	isgomock struct{}
}

// mockStorageFileReaderMockRecorder is the mock recorder for mockStorageFileReader.
type mockStorageFileReaderMockRecorder struct {
	mock *mockStorageFileReader
}

// NewmockStorageFileReader creates a new mock instance.
func NewmockStorageFileReader(ctrl *gomock.Controller) *mockStorageFileReader {
	mock := &mockStorageFileReader{ctrl: ctrl}
	mock.recorder = &mockStorageFileReaderMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *mockStorageFileReader) EXPECT() *mockStorageFileReaderMockRecorder {
	return m.recorder
}

// ReadFiles mocks base method.
func (m *mockStorageFileReader) ReadFiles(ctx context.Context, storage model.Storage, path, filterStr string) ([]*bytes.Buffer, error) {
	m.ctrl.T.Helper()
...
func (mr *mockStorageFileReaderMockRecorder) ReadFiles(ctx, storage, path, filterStr any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReadFiles", reflect.TypeOf((*mockStorageFileReader)(nil).ReadFiles), ctx, storage, path, filterStr)
}

// mockStorageDataWriter is a mock of storageDataWriter interface.
type mockStorageDataWriter struct {
	ctrl     *gomock.Controller
	recorder *mockStorageDataWriterMockRecorder
	isgomock struct{}
}

// mockStorageDataWriterMockRecorder is the mock recorder for mockStorageDataWriter.
type mockStorageDataWriterMockRecorder struct {
	mock *mockStorageDataWriter
}

// NewmockStorageDataWriter creates a new mock instance.
func NewmockStorageDataWriter(ctrl *gomock.Controller) *mockStorageDataWriter {
	mock := &mockStorageDataWriter{ctrl: ctrl}
	mock.recorder = &mockStorageDataWriterMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *mockStorageDataWriter) EXPECT() *mockStorageDataWriterMockRecorder {
	return m.recorder
}

// WriteDataFile mocks base method.
func (m *mockStorageDataWriter) WriteDataFile(ctx context.Context, storage model.Storage, fileName string, content []byte) error {
	m.ctrl.T.Helper()
...
func (mr *mockStorageDataWriterMockRecorder) WriteDataFile(ctx, storage, fileName, content any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WriteDataFile", reflect.TypeOf((*mockStorageDataWriter)(nil).WriteDataFile), ctx, storage, fileName, content)
}
