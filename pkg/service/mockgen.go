...
// Source: github.com/aerospike/aerospike-backup-service/v3/pkg/service (interfaces: RestoreManager,BackupReaderWriter,BackupReader,RunningBackupsRegistry,RetentionManager,ClusterConfigWriter,CancelableBackupHandler,routineProvider,HistoryManager,BackupCompletionHandler,RestoreValidator,StartController,RoutineBackupRunner,NamespaceBackupRunner,BackupReporter,BackupOrchestrator,JobScheduler,storageFileReader,storageDataWriter)
//
// Generated by this command:
//
//	mockgen -package service -destination pkg/service/mockgen.go -mock_names=routineProvider=mockRoutineProvider,storageFileReader=mockStorageFileReader,storageDataWriter=mockStorageDataWriter github.com/aerospike/aerospike-backup-service/v3/pkg/service RestoreManager,BackupReaderWriter,BackupReader,RunningBackupsRegistry,RetentionManager,ClusterConfigWriter,CancelableBackupHandler,routineProvider,HistoryManager,BackupCompletionHandler,RestoreValidator,StartController,RoutineBackupRunner,NamespaceBackupRunner,BackupReporter,BackupOrchestrator,JobScheduler,storageFileReader,storageDataWriter
//
...
func (m *MockRunningBackupsRegistry) clearFailedBackup(routineName string, jt model.BackupType) {
	m.ctrl.T.Helper()
...
func (m *MockRunningBackupsRegistry) register(routineName string, jt model.BackupType, handler CancelableBackupHandler) {
	m.ctrl.T.Helper()
