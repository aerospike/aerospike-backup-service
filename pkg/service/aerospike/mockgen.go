...
//
//	mockgen -package aerospike -destination pkg/service/aerospike/mockgen.go github.com/aerospike/aerospike-backup-service/v3/pkg/service/aerospike ClientManager,NamespaceValidator,Client,ClientFactory
//
