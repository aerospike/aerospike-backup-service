...
generate_mocks \
    "pkg/service" \
    "RestoreManager,BackupReaderWriter,BackupReader,RunningBackupsRegistry,RetentionManager,"\
    "ClusterConfigWriter,CancelableBackupHandler,PathService,routineProvider,HistoryManager"
