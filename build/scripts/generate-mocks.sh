...
generate_mocks \
    "pkg/service" \
    "RestoreManager,BackupReaderWriter,BackupReader,RunningBackupsRegistry,RetentionManager,ClusterConfigWriter,CancelableBackupHandler"
...
generate_mocks \
    ...
    "ClientManager,Backuper,Restorer,Client,ClientFactory"
