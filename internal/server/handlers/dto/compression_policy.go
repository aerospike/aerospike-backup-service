...
// MapCompressionPolicyFromDTO maps dro CompressionPolicy to model.CompressionPolicy.
func MapCompressionPolicyFromDTO(dto CompressionPolicy) model.CompressionPolicy {
