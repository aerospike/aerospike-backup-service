...
| `aerospike_backup_service_backups_active`                           | Gauge     | Number of backups currently running for the given routine and backup type (full/incremental)                                                          | routine, type          |
...
| `aerospike_backup_service_restores_active`                          | Gauge     | Number of restore processes running                                                                                                                   |                        |
| `aerospike_backup_service_restores_total`                           | Counter   | Total completed restore jobs by outcome (success, failure, canceled)                                                                                  | outcome                |
...
| `aerospike_backup_service_restore_in_progress`                      | Gauge     | Number of restore processes running (Deprecated: use aerospike_backup_service_restores_active instead.)                                               |                        |
